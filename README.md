## smacc2 (humble) - 2.3.18-1

The packages in the `smacc2` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --track humble smacc2` on `Mon, 17 Jul 2023 08:37:26 -0000`
...
- old version: `2.3.16-1`
- new version: `2.3.18-1`
...
The packages in the `smacc2` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --track humble smacc2` on `Sun, 12 Mar 2023 21:17:41 -0000`
